...
export default function Navbar() {
    ...
    console.log("role recibido en Navbar instructor:", role);
    console.log("token recibido en Navbar instructor:", token);
    console.log("username recibido en Navbar instructor:", username);
