...
export default function Navbar() {
    ...
    console.log("role recibido en Navbar manager:", role);
    console.log("token recibido en Navbar manager:", token);
    console.log("username recibido en Navbar manager:", username);
