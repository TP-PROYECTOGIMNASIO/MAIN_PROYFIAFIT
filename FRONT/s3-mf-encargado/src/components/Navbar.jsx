...
export default function Navbar() {
    ...
    console.log("role recibido en Navbar encargado:", role);
    console.log("token recibido en Navbar encargado:", token);
    console.log("username recibido en Navbar encargado:", username);
