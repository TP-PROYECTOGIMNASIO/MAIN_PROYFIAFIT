...
export default function Navbar() {
    ...
    console.log("role recibido en Navbar fisioterapeuta:", role);
    console.log("token recibido en Navbar fisioterapeuta:", token);
    console.log("username recibido en Navbar fisioterapeuta:", username);
