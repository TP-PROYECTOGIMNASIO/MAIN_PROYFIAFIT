...
export default function Navbar() {
    ...
    console.log("role recibido en Navbar recepcionista:", role);
    console.log("token recibido en Navbar recepcionista:", token);
    console.log("username recibido en Navbar recepcionista:", username);
