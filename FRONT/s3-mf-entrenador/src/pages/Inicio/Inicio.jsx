      ...
      <div className="w-full max-w-4xl relative z-10"> {/* Añado relative y z-10 */}
        ...
        <div className="grid grid-cols-2 gap-12">
          ...
          <div className="flex flex-col gap-4 bg-gray-100 p-4 rounded-b-lg max-w-xs mx-auto">
              <Link to={"/"} className="bg-white text-gray-600 border border-white-600 font-semibold py-2 px-4 rounded-lg">
                <h3 className="text-lg text-center">CALCULAR</h3>
		            <h3 className="text-lg text-center">METRICAS</h3>
              </Link>
              <Link to={"/"}className="bg-white text-gray-600 border border-white-600 font-semibold py-2 px-4 rounded-lg">
                <h3 className="text-lg text-center">EDITAR RANGO</h3>
              </Link>
              <Link to={"/asignar-alumno"} className="bg-white text-gray-600 border border-white-600 font-semibold py-2 px-4 rounded-lg">
