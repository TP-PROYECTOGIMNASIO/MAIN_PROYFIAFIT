...
export default function Navbar() {
    ...
    console.log("role recibido en Navbar nutricionista:", role);
    console.log("token recibido en Navbar nutricionista:", token);
    console.log("username recibido en Navbar nutricionista:", username);
